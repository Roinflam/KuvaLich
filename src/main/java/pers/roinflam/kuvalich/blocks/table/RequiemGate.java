...
public class RequiemGate extends Block implements IHasModel, IHasItem {

    @Nullable
    private final ItemBlock itemBlock;

    public RequiemGate(@Nonnull String name, @Nonnull Material material, @Nonnull CreativeTabs creativeTabs) {
        super(material);
    ...
    public static Block getBlock() {
        return KuvaLichBlocks.REQUIEM_GATE;
    }
    ...
    public boolean onBlockActivated(@Nonnull World worldIn, @Nonnull BlockPos pos, @Nonnull IBlockState state, @Nonnull EntityPlayer playerIn, @Nonnull EnumHand hand, @Nonnull EnumFacing facing, float hitX, float hitY, float hitZ) {
        if (!worldIn.isRemote) {
            ...
            playerIn.openGui(Reference.MOD_ID, KuvaLichGuiHandler.REQUIEM_GATE, worldIn, x, y, z);
        }
        return true;
    }

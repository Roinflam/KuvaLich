...
public class EntityKuvaMaster extends KuvaBase {
    ...
    public boolean attackEntityAsMob(@Nonnull Entity entityIn) {
        ...
        for (EntityLivingBase entityLivingBase : EntityUtil.getNearbyEntities(EntityLivingBase.class, this, 3, entity -> !(entity instanceof KuvaBase) && !entity.equals(entityIn))) {
                ...
                if (requiemCard.isReadyCard()) {
                    if (requiemCard.isCorrectAnswer()) {
                        ...
                        if (requiemCard.getMinimumLevelWeapon() < ConfigKuvaLich.minimumLevel) {
                            ...
                            TextComponentTranslation textComponentString = new TextComponentTranslation("message.kuvalich.minimumLevelWeapon", requiemCard.getMinimumLevelWeapon());
                        ...
                        if (requiemCard.getMaximumLevelWeapon() < ConfigKuvaLich.maximumLevel) {
                            ...
                            TextComponentTranslation textComponentString = new TextComponentTranslation("message.kuvalich.maximumLevelWeapon", requiemCard.getMaximumLevelWeapon());
                            textComponentString.getStyle().setColor(TextFormatting.GREEN);
                            player.sendMessage(textComponentString);
                        }
                    ...
                    if (requiemCard.isFirstCorrectAnswer()) {
                        TextComponentTranslation textComponentString = new TextComponentTranslation("message.kuvalich.firstCorrect");
                    ...
                    TextComponentTranslation textComponentString = new TextComponentTranslation("message.kuvalich.failedToDecrypt", requiemCard.getKuvaLevel());
                    textComponentString.getStyle().setColor(TextFormatting.RED);
                    player.sendMessage(textComponentString);
                }

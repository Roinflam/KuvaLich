...
public class EntityPlayerUtil {
    ...
    public static float getAttackDamage(EntityPlayer entityPlayer, Entity targetEntity) {
        ...
        net.minecraftforge.event.entity.player.CriticalHitEvent hitResult = net.minecraftforge.common.ForgeHooks.getCriticalHit(entityPlayer, targetEntity, isCriticalHit, isCriticalHit ? 1.5F : 1.0F);
        if (hitResult != null) {

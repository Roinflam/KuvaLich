 ...
 */
@OnlyIn(Dist.CLIENT)
public class ScreenRequiemWarframeTable extends AbstractContainerScreen<MenuRequiemWarframeTable> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(
            Reference.MOD_ID, "textures/gui/container/requiem_warframe_table.png"
    );

    public ScreenRequiemWarframeTable(MenuRequiemWarframeTable menu, Inventory playerInventory, Component title) {

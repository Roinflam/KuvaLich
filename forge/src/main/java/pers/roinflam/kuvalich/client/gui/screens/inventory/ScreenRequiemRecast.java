 ...
 */
@OnlyIn(Dist.CLIENT)
public class ScreenRequiemRecast extends AbstractContainerScreen<MenuRequiemRecast> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(
            Reference.MOD_ID, "textures/gui/container/requiem_recast.png"
    );

    public ScreenRequiemRecast(MenuRequiemRecast menu, Inventory playerInventory, Component title) {
